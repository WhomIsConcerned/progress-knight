...
function createHeaderRow(template, categoryType, categoryName, table) {
  ...
  if (categoryType != itemCategories) {
    row.getElementsByClassName("valueType")[0].textContent =
...
function updateRequiredRows(data, categoryType) {
  var requiredRows = rows["requiredRows"];

  for (key in requiredRows) {
    var requiredRow = requiredRows[key];
    var category = categoryType[key];
...
function updateHeaderRows(categories) {
  for (categoryName in categories) {
    var headerRow = rows["headerRows"][categoryName];
...
gameData.requirements = {
  ...
  "The Arcane Association": new TaskRequirement(
    [
      rows["headerRows"]["The Arcane Association"],
      rows["requiredRows"]["The Arcane Association"],
    ],
    [
  ...
  "Dark magic": new EvilRequirement(
    [rows["headerRows"]["Dark magic"], rows["requiredRows"]["Dark magic"]],
    [{ requirement: 1 }]
  ),
  ...
  "Evil info": new EvilRequirement(
    [document.getElementById("evilInfo")],
    [{ requirement: 1 }]
  ),
  ...
  Fisherman: new TaskRequirement("Fisherman", [
    { task: "Farmer", requirement: 10 },
  ]),
  Miner: new TaskRequirement("Miner", [
    { task: "Strength", requirement: 10 },
    { task: "Fisherman", requirement: 10 },
  ]),
  Blacksmith: new TaskRequirement("Blacksmith", [
    { task: "Strength", requirement: 30 },
    { task: "Miner", requirement: 10 },
  ]),
  Merchant: new TaskRequirement("Merchant", [
  ...
  //The Arcane Association
  Student: new TaskRequirement("Student", [
    { task: "Concentration", requirement: 200 },
    { task: "Meditation", requirement: 200 },
  ]),
  "Apprentice mage": new TaskRequirement("Apprentice mage", [
    { task: "Mana control", requirement: 400 },
    { task: "Student", requirement: 10 },
  ]),
  Mage: new TaskRequirement("Mage", [
    { task: "Mana control", requirement: 700 },
    { task: "Apprentice mage", requirement: 10 },
  ]),
  Wizard: new TaskRequirement("Wizard", [
    { task: "Mana control", requirement: 1000 },
    { task: "Mage", requirement: 10 },
  ]),
  "Master wizard": new TaskRequirement("Master wizard", [
    { task: "Mana control", requirement: 1500 },
    { task: "Wizard", requirement: 10 },
  ]),
  Chairman: new TaskRequirement("Chairman", [
  ...
  Productivity: new TaskRequirement("Productivity", [
    { task: "Concentration", requirement: 5 },
  ]),
  Bargaining: new TaskRequirement("Bargaining", [
    { task: "Concentration", requirement: 20 },
  ]),
  Meditation: new TaskRequirement("Meditation", [
  ...
  "Battle tactics": new TaskRequirement("Battle tactics", [
    { task: "Concentration", requirement: 20 },
  ]),
  "Muscle memory": new TaskRequirement("Muscle memory", [
    { task: "Concentration", requirement: 30 },
    { task: "Strength", requirement: 30 },
  ]),

  //Magic
  "Mana control": new TaskRequirement("Mana control", [
    { task: "Concentration", requirement: 200 },
    { task: "Meditation", requirement: 200 },
  ]),
  Immortality: new TaskRequirement("Immortality", [
    { task: "Apprentice mage", requirement: 10 },
  ]),
  "Time warping": new TaskRequirement("Time warping", [
    { task: "Mage", requirement: 10 },
  ]),
  "Super immortality": new TaskRequirement("Super immortality", [
  ...
  "Demon training": new EvilRequirement("Demon training", [
    { requirement: 25 },
  ]),
  "Blood meditation": new EvilRequirement("Blood meditation", [
    { requirement: 75 },
  ]),
  "Demon's wealth": new EvilRequirement("Demon's wealth", [
    { requirement: 500 },
  ]),
